function ValOut=NormaliseComp(ValIn, series)
    E3 = [1.0, 2.2, 4.7, 10];
    E6 = [1.0, 1.5, 2.2, 3.3, 4.7, 6.8, 10];
    ...
    switch series
        ...
        case 96, E = E96;
        otherwise
            error(['The serie E' num2str(series) 'does not exist']);
    end

    ValExp = floor(log10(ValIn));
    ValBase = ValIn./(10.^ValExp);
    [x,index] = min(abs(ValBase - E));
    ValOut = E(index) * 10^ValExp;  
