...
if y > 1
    ...
    % Tolérences
    R1_t = R1_n     *  [1.002 1 1 1 1];
    R2_t = R2_n     *  [1 1.02 1 1 1];
    R3_t = R3_n     *  [1 1 1.001 1 1];
    Vref_t = Vref   *  [1 1 1 1.001 1];
    VDD_t =  VDD    *  [1 1 1 1 1.01];
...
%% Résultats
fprintf('\n===== RESULTATS CALCUL (NON-INVERSEUR) =====\n');
